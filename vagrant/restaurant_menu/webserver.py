...
class WebServerHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        #    output += '''<form method='POST' enctype='multipart/form-data' action='/resultmessage'><h2>What would you like me to say?</h2><input name="message" type="text" ><input type="submit" value="Submit"> </form>'''
        #    output += "</body></html>"
        #    self.wfile.write(output)
        #    print output
